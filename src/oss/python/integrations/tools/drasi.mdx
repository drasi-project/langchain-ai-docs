...
This is useful for buffering incoming change notifications when you workflow is busy on something else, you can then have a loop in the workflow to consume the notifications from the buffer when it is ready.
